...
public class Hundredtwo {
	...
	public static void main(String [] args) {
		...
		try {
			...
			System.out.println("Data before Deserialization of object");
			printdata(e);
			Emply.b=20;//value of static variable is changed
		}
		catch(IOException i) {
		...
		try {
			...
			e=(Emply)in.readObject();//method for deserialization of object
			file.close();
			in.close();
			
			System.out.println("Object has been deserialized");
			System.out.println("Data after Deserialization of object");
...
//changed. The reason being a was marked as transient and b was static. In case of transient variables:-
...
//(e.g: for objects it is null, for int it is 0). In case of static Variables:
